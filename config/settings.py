...
ALLOWED_HOSTS = os.environ.get("ALLOWED_HOSTS","marcmind.com,www.marcmind.com","marcmind-coaching-suscription-websi.vercel.app", "marcmind-coaching-suscription-websi-tau.vercel.app").split(",")
